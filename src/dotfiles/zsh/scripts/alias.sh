...
alias hotkit="yarn hotdog --env.entries=styleguide"
alias hotspa="yarn hotdog --env.entries=spa"
alias hotdog="yarn hotdog --env.entries=watchdog"
alias hotk9="yarn hotdog --env.entries=security"
